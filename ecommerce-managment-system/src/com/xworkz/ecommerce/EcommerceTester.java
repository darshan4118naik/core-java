...
import com.xworkz.ecommerce.crud.Ecommerce;
import com.xworkz.ecommerce.crud.impl.EcommerceImp;
...
public class EcommerceTester {
	...
	public static void main(String[] args) {
		...
		int size =sc.nextInt();
		Ecommerce ec = new EcommerceImp(size);
		  ...
		  System.out.println("Enter 1 to fetch all the Order details : ");
		   System.out.println("Enter 2 to update Type by Id : ");
		    System.out.println("Enter 3 to delete Order By Name : ");
			 ...
			 System.out.println("Enter 6 to get Type By Name : ");
