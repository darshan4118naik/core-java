...
restaurant2.restaurantName="Biryani Hutt";
restaurant2.location="Rajajinagar";
restaurant2.contactNo=8567923145L;
restaurant2.ownerName="Suhash";

System.out.println("---------------------------------------------------");
System.out.println("restaurant name is " +restaurant2.restaurantName);
System.out.println("restaurant located in " +restaurant2.location);
System.out.println("restaurant contactNo is " +restaurant2.contactNo);
System.out.println("restaurant owner name is " +restaurant2.ownerName);
